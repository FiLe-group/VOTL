...
public class CommandBuilder
{
	...
	@Nonnull private Permission[] userPermissions = new Permission[0];
	@Nonnull private Permission[] botPermissions = new Permission[0];
	...
	public CommandBuilder setUserPermissions(Collection<Permission> userPermissions)
	{
		if(userPermissions == null)
			...
			this.userPermissions = Objects.requireNonNull((Permission[]) userPermissions.toArray());
		return this;
	}
	...
	public CommandBuilder setBotPermissions(Collection<Permission> botPermissions)
	{
		if(botPermissions == null)
			...
			this.botPermissions = Objects.requireNonNull((Permission[]) botPermissions.toArray());
		return this;
	}
