 ...
 */
package com.github.fileeditor97.votl.objects.command;
...
import com.github.fileeditor97.votl.objects.command.impl.CommandClientImpl;
...
public class CommandEvent
{
	 ...
	 *         The Consumer to queue after sending the Message is sent.
	 */
	public void reply(@Nonnull MessageEmbed embed, Consumer<Message> success)
	{
		event.getChannel().sendMessageEmbeds(embed).queue(m -> {
			if(event.isFromType(ChannelType.TEXT))
				linkId(m);
	 ...
	 *         The Consumer to run if an error occurs when sending the Message.
	 */
	public void reply(@Nonnull MessageEmbed embed, Consumer<Message> success, Consumer<Throwable> failure)
	{
		event.getChannel().sendMessageEmbeds(embed).queue(m -> {
			if(event.isFromType(ChannelType.TEXT))
				linkId(m);
	 ...
	 */
	public void reply(@Nonnull MessageCreateData message)
	{
	 ...
	 */
	public void reply(@Nonnull MessageCreateData message, Consumer<Message> success)
	{
		event.getChannel().sendMessage(message).queue(m -> {
			if(event.isFromType(ChannelType.TEXT))
				linkId(m);
	 ...
	 *         The Consumer to run if an error occurs when sending the Message.
	 */
	public void reply(@Nonnull MessageCreateData message, Consumer<Message> success, Consumer<Throwable> failure)
	{
		event.getChannel().sendMessage(message).queue(m -> {
			if(event.isFromType(ChannelType.TEXT))
				linkId(m);
	 ...
	 */
	public void reply(@Nonnull File file, @Nonnull String filename)
	{
	 ...
	 *         The filename that Discord should display (null for default).
	 */
	public void reply(@Nonnull String message, @Nonnull File file, @Nonnull String filename)
	{
	 ...
	 */
	public void replyOrAlternate(@Nonnull MessageEmbed embed, String alternateMessage)
	{
		try {
	 ...
	 */
	public void replyOrAlternate(@Nonnull String message, @Nonnull File file, @Nonnull String filename, String alternateMessage)
	{
		try {
			event.getChannel().sendFiles(FileUpload.fromData(file, filename)).addContent(message).queue();
		} catch(Exception e) {
	 ...
	 *         The MessageEmbed to reply with
	 */
	public void replyInDm(@Nonnull MessageEmbed embed)
	{
		if(event.isFromType(ChannelType.PRIVATE))
			reply(embed);
		else
	 ...
	 *         The Consumer to queue after sending the Message is sent.
	 */
	public void replyInDm(@Nonnull MessageEmbed embed, Consumer<Message> success)
	{
		if(event.isFromType(ChannelType.PRIVATE))
	 ...
	 *         The Consumer to run if an error occurs when sending the Message.
	 */
	public void replyInDm(@Nonnull MessageEmbed embed, Consumer<Message> success, Consumer<Throwable> failure)
	{
		if(event.isFromType(ChannelType.PRIVATE))
	 ...
	 *         The Message to reply with
	 */
	public void replyInDm(@Nonnull MessageCreateData message)
	{
		if(event.isFromType(ChannelType.PRIVATE))
			reply(message);
		else
	 ...
	 *         The Consumer to queue after sending the Message is sent.
	 */
	public void replyInDm(@Nonnull MessageCreateData message, Consumer<Message> success)
	{
		if(event.isFromType(ChannelType.PRIVATE))
	 ...
	 *         The Consumer to run if an error occurs when sending the Message.
	 */
	public void replyInDm(@Nonnull Message message, Consumer<Message> success, Consumer<Throwable> failure)
	{
		if(event.isFromType(ChannelType.PRIVATE))
	 ...
	 *         The filename that Discord should display (null for default).
	 */
	public void replyInDm(@Nonnull String message, @Nonnull File file, @Nonnull String filename)
	{
		if(event.isFromType(ChannelType.PRIVATE))
