...
public enum CCooldownScope
{
	...
	CCooldownScope(String format, String errorPath)
	{
		this.format = format;
		this.errorPath = errorPath;
	}

	// AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, that's retarded...maybe
	public static CCooldownScope fromOriginal(CooldownScope cs) {
		switch (cs) {
			case USER:
				return USER;
			case CHANNEL:
